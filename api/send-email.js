...
function buildPasswordResetHtml(data) {
  const firstName = escapeHtml(firstNameFromData(data));
  const resetLink = escapeHtml(data.resetLink || data.actionUrl || '#');
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:580px; width:100%; background-color:#FFFFFF; border-radius:12px; overflow:hidden; box-shadow:0 2px 12px rgba(0,0,0,0.06);">
            ...
            <td style="background-color:#FFFFFF; padding:32px 40px 0 40px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td align="right" valign="middle">
                    <span style="font-family:'Poppins', Arial, sans-serif; font-size:11px; color:#9E9E9E; letter-spacing:0.08em; text-transform:uppercase;">Account security</span>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="background-color:#FFFFFF; padding:36px 40px 40px;">
              <p style="font-family:'Poppins', Arial, sans-serif; font-size:40px; margin:0 0 16px 0; line-height:1;">🔐</p>
              <h1 style="font-family:'Poppins', Arial, sans-serif; font-size:26px; font-weight:700; color:#111111; letter-spacing:-0.02em; line-height:1.25; margin:0 0 14px 0;">
                Password reset request, ${firstName}.
              </h1>
              <p style="font-family:'Poppins', Arial, sans-serif; font-size:15px; color:#555555; line-height:1.7; margin:0 0 10px 0;">
                We received a request to reset the password for your Nearwork account. Click the button below to set a new one and get back in.
              </p>
              <p style="font-family:'Poppins', Arial, sans-serif; font-size:15px; color:#555555; line-height:1.7; margin:0 0 28px 0;">
              ...
              <p style="font-family:'Poppins', Arial, sans-serif; font-size:12px; color:#9E9E9E; margin:0 0 32px 0; line-height:1.6;">
                🔒 This link is unique to your account, expires shortly, and should never be shared with anyone — including Nearwork staff.
              </p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:18px;">
                <tr>
                  ...
                  <td valign="top">
                    <p style="font-family:'Poppins', Arial, sans-serif; font-size:14px; font-weight:600; color:#111111; margin:0 0 3px 0; line-height:1.4;">Use at least 8 characters</p>
                    <p style="font-family:'Poppins', Arial, sans-serif; font-size:13px; color:#9E9E9E; margin:0; line-height:1.5;">Mix uppercase, lowercase, numbers, and symbols for a stronger password.</p>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:18px;">
                <tr>
                  ...
                  <td valign="top">
                    <p style="font-family:'Poppins', Arial, sans-serif; font-size:14px; font-weight:600; color:#111111; margin:0 0 3px 0; line-height:1.4;">Avoid obvious choices</p>
                    <p style="font-family:'Poppins', Arial, sans-serif; font-size:13px; color:#9E9E9E; margin:0; line-height:1.5;">Don't use your name, birthday, or common words like "password123".</p>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
                <tr>
                  ...
                  <td valign="top">
                    <p style="font-family:'Poppins', Arial, sans-serif; font-size:14px; font-weight:600; color:#111111; margin:0 0 3px 0; line-height:1.4;">Don't reuse passwords</p>
                    <p style="font-family:'Poppins', Arial, sans-serif; font-size:13px; color:#9E9E9E; margin:0; line-height:1.5;">Use a unique password for your Nearwork account to keep it secure.</p>
                  </td>
                </tr>
              </table>
...
function buildHtml(template, data) {
  ...
  if (data.templateId === 'password_reset') return buildPasswordResetHtml(data);
...
function buildPlainText(template, data) {
  ...
  if (data.templateId === 'password_reset') {
    const resetLink = data.resetLink || data.actionUrl || actionUrl;
    return [
      `Hi ${firstName},`,
      '',
      'We received a request to reset the password for your Nearwork account.',
      'Click the link below to set a new password:',
      '',
      resetLink,
      '',
      'This link is unique to your account and expires shortly.',
