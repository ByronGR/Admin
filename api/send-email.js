...
function buildHtml(template, data) {
  ...
  return `<!doctype html>
<html>
  <body style="margin:0;background:#f6f7fb;font-family:Arial,sans-serif;color:#0D0D0D;">
    <div style="max-width:620px;margin:0 auto;padding:28px 16px;">
      <div style="background:#0D0D0D;color:#fff;border-radius:14px 14px 0 0;padding:22px 24px;font-size:22px;font-weight:800;">Near<span style="color:#8B5CF6;">work</span></div>
      <div style="background:#fff;border:1px solid #E5E7EB;border-top:0;border-radius:0 0 14px 14px;padding:28px 24px;">
        ...
        ${extra}
        <a href="${escapeHtml(actionUrl)}" style="display:inline-block;margin-top:18px;background:#6C3CE1;color:#fff;text-decoration:none;border-radius:9px;padding:12px 18px;font-size:14px;font-weight:700;">${actionText}</a>
        <p style="font-size:12px;line-height:1.6;color:#6B7280;margin:24px 0 0;">Nearwork Team</p>
      </div>
    </div>
  </body>
</html>`;
