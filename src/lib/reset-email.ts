...
// Sent server-side via Resend from /api/send-reset.

export const RESET_EMAIL_HTML = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
export function buildResetEmail(firstName: string, resetLink: string): string {
  return RESET_EMAIL_HTML
