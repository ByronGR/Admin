...
export const CHANGELOG: ChangelogRelease[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: 'Technical', items: ['Read-only page at /raia. Nothing it does changes a candidate, an opening or a pipeline.'] },
    ],
  },
  {
    version: '1.28.0',
  ...
  },
  {
    ...
    date: '2026-07-26',
    sections: [
      { title: 'Fixed', items: ['Paused/cancelled/filled openings no longer appear under the "Active" pipelines filter — the filter now uses the opening status too.'] },
    ],
  },
  {
    version: '1.27.4',
    date: '2026-07-26',
    sections: [
      { title: 'Fixed', items: ['Pipelines list badge now reflects a paused/cancelled/filled opening in real time, including openings paused earlier.'] },
    ],
  },
  {
    version: '1.27.3',
